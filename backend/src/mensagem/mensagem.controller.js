...
var MensagemController = function () {
    var _classDecorators = [(0, common_1.Controller)('mensagem')];
    ...
    var MensagemController = _classThis = /** @class */ (function () {
        function MensagemController_1(mensagemService) {
            this.mensagemService = (__runInitializers(this, _instanceExtraInitializers), mensagemService);
        }
        MensagemController_1.prototype.criar = function (data) {
            return this.mensagemService.criar(data);
        };
        MensagemController_1.prototype.listar = function () {
            return this.mensagemService.listar();
        };
        MensagemController_1.prototype.buscar = function (id) {
            return this.mensagemService.buscar(+id);
        };
        MensagemController_1.prototype.deletar = function (id) {
            return this.mensagemService.deletar(+id);
        };
        return MensagemController_1;
    }());
    __setFunctionName(_classThis, "MensagemController");
    (function () {
        ...
        MensagemController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MensagemController = _classThis;
}();
